...
| Question | Document |
|---|---|
| What is it, and how do I run it locally? | this file |
...
**Read the Standing rules in `DECISIONS_AND_INCIDENTS.md` before changing the
key, the export filter, or anything that prints a value.** Each one exists
